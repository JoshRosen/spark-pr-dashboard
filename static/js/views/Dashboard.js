    ...
    var Dashboard = React.createClass({displayName: 'Dashboard',
      ...
      render: function() {
        ...
        if (this.state.prs.length > 0) {
          subNavigation = React.createElement(SubNavigation, {prs: this.state.prs, active: this.state.active, onClick: this._filterPrsByComponent});
          mainView = (React.createElement("div", {className: "container-fluid"}, 
